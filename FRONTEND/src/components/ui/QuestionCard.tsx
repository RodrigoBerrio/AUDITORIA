...
interface Props {
  pregunta: Pregunta;
  /** Posición secuencial de la pregunta dentro del cuestionario activo (1-based), no el `numero` original del catálogo. */
  numero: number;
 ...
 * datos, no de markup.
 */
export function QuestionCard({ pregunta, numero, totalPreguntas, valor, observacion, onResponder }: Props) {
  return (
    <div className="q-card">
      <div className="q-num">Pregunta {numero} de {totalPreguntas}</div>
      ...
      <EvidenciaUpload preguntaId={pregunta.id} />
      <div className="q-obs">
        <input
          type="text"
