...
export function EmpresasPage() {
  ...
  const { mostrarToast, pedirConfirmacion, setEmpresaActiva } = useAppStore();
    ...
    <div>
      <div className="card">
        ...
        <div className="form-footer">
          <button className="btn btn-primary" onClick={guardarYContinuar}>
            <i className="ti ti-arrow-right" /> Guardar y definir áreas a auditar
          </button>
